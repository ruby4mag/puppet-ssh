...
1. [Setup - The basics of getting started with sshnew](#setup)
    * [What sshnew affects](#what-sshnew-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with sshnew](#beginning-with-sshnew)
